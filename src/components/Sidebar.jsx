  ...
  return (
    <aside className={`sidebar ${open ? 'open' : ''}`}>
      ...
      <div className="sidebar-footer">
        <button className="nav-item" onClick={() => onNavigate('profile')} title={!open ? 'Profile' : undefined}>
          {icons.profile}<span className="nav-label">Profile</span>
        </button>
        <button className="nav-item" onClick={signOut} title={!open ? 'Sign out' : undefined}>
          {icons.logout}<span className="nav-label">Sign out</span>
        </button>
