...
const icons = {
  ...
  import:    (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>),
  ...
  developer: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>),
        ...
        <nav className="sidebar-nav">
          ...
          {isAdmin && (
            <>
              ...
              <button className={`nav-item ${activePage==='developer'?'active':''}`} onClick={()=>navigateAndClose('developer')} title={!effectiveOpen?'Developer':undefined}>{icons.developer}<span className="nav-label">Developer</span></button>
